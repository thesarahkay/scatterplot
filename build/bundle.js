...
},{"./is-object":6,"form-data":3}],8:[function(require,module,exports){
...
var legendData = [{ Name: 'Doping Allegations', Doping: true }, { Name: 'No Doping Allegations' }];
var margin = {
  top: 80,
  left: 60,
  right: 100,
...
function init(err, response) {
  ...
  var legend = scatter.append('g').attr('transform', "translate(" + (width - 50) + "," + height / 2 + ")");

  var legendCircles = legend.selectAll('.legend').data(legendData).enter().append('circle').attr('fill', _fill).attr('cy', legendY).attr('r', r);
